...
frontend/
  ...
  src/app/
    ...
    components/
      ...
      redesign/folio/            Folio (books+facts) feed: FolioCard (no-card print page, small-caps text action row), FolioFeedStates (ellipsis loading, hairline empty), FolioBottomNav (hairline bar, underline tick), folioHeader (running-head tabs, hidden indicator, bare magnifier)
