...
// Comment list state shared by the baseline CommentsBottomSheet and the
// design-variant comment surfaces (redesign/*). Draft text and gestures stay
// in each component; this hook owns fetching, posting, and deleting.
